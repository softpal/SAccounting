...
{
    public class StratusReportsController : BasicController
    {
        ...
        IList<Ledger_DTO> GetLedgers(int? accountId, DateTime? fromDate, DateTime? toDate, int? pageNo, int? pageSize)
        {
            ...
            }, "Value", "Text", accountId) : new SelectList(Ledgers.GetLedgerAccounts(BusinessId, UserId), "UserAccountsId", "AccountName", accountId);
        ...
        public ActionResult Ledger(int? accountId, DateTime? fromDate, DateTime? toDate, int? pageNo, int? pageSize)
        {
            ...
            ViewBag.UserAccounts = new SelectList(Ledgers.GetLedgerAccounts(BusinessId, UserId), "UserAccountsId", "AccountName", accountId);
